...
namespace Vpassbackend.Services
{
    public class AppointmentBookingService
    {
        ...
        public AppointmentBookingService(ApplicationDbContext context, LocationService locationService)
        {
            _context = context;
        ...
        public async Task<List<ServiceCenterRecommendationDTO>> GetNearbyServiceCenters(
        ...
        // Book an appointment
        public async Task<AppointmentConfirmationDTO> BookAppointment(AppointmentBookingDTO bookingDto)
        {
        ...
        public async Task<AppointmentConfirmationDTO> ProcessPayment(AppointmentPaymentDTO paymentDto)
        {
        ...
        public async Task<AppointmentConfirmationDTO> GetAppointmentDetails(int appointmentId)
        {
            var appointment = await _context.Appointments
                .Include(a => a.ServiceCenter)
