...
namespace Vpassbackend.Migrations
{
    ...
    [Migration("20260217054733_AddVehicleTransferSystem")]
    partial class AddVehicleTransferSystem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vpassbackend.Models.ChatConversation", b =>
                {
            ...
            modelBuilder.Entity("Vpassbackend.Models.ChatMessage", b =>
                {
            ...
            modelBuilder.Entity("Vpassbackend.Models.KnowledgeDocument", b =>
                {
                    b.Property<int>("DocumentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vpassbackend.Models.VehicleTransfer", b =>
                {
                    ...
                    b.Property<int?>("MileageAtTransfer")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Vpassbackend.Models.ChatConversation", b =>
                {
                    ...
                    b.HasOne("Vpassbackend.Models.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Vpassbackend.Models.ChatMessage", b =>
                {
                    b.HasOne("Vpassbackend.Models.ChatConversation", "Conversation")
                        .WithMany("Messages")
            ...
            modelBuilder.Entity("Vpassbackend.Models.VehicleTransfer", b =>
                {
                    b.HasOne("Vpassbackend.Models.Customer", "FromOwner")
                        .WithMany()
                        .HasForeignKey("FromOwnerId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Vpassbackend.Models.Customer", "ToOwner")
                        .WithMany()
